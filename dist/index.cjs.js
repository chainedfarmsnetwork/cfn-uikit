...
var Icon$H = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default['default'].createElement("image", { width: "32", height: "32", href: "images/cfn/logo.png" })));
};
...
var Icon$C = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "images/cfn/9.png" })));
};
    ...
    return (React__default['default'].createElement(StyledAlert, null,
        ...
        onClick && (React__default['default'].createElement(CloseHandler, null,
            React__default['default'].createElement(IconButton, { size: "sm", variant: "text", onClick: onClick },
                React__default['default'].createElement(Icon$N, { width: "30px", color: "currentColor" }))))));
};
...
var DefaultSeparator = React__default['default'].createElement(Icon$P, { color: "currentColor", width: "30px" });
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
        React__default['default'].createElement("image", { width: "205", height: "26", href: isDark ? "images/cfn/LogoTextNewDark.png" : "images/cfn/LogoTextNewWhite.png" })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "30px" }, isPushed ? (React__default['default'].createElement(Icon$m, { width: "30px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$n, { width: "30px", color: "textSubtle" }))),
...
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container, null,
        ...
        React__default['default'].createElement(SocialEntry, null, cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: priceLink, target: "_blank", style: { margin: "auto" } },
            React__default['default'].createElement(Icon$C, { width: "30px", mr: "8px" }),
...
var CopyToClipboard = function (_a) {
    ...
    return (React__default['default'].createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React__default['default'].createElement(Icon$K, { width: "26px", color: "primary", ml: "4px" }),
...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#E8B100", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#27262c", input: "#343135", 
    // primaryDark: "#0098A1",
    tertiary: "#343135", text: "#F9F1E0", textDisabled: "#666171", textSubtle: "#E8B100", borderColor: "#343135", card: "#27262c", gradients: {
