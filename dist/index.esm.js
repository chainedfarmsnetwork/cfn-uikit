...
var Icon$R = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 25 24" }, props),
        React.createElement("path", { d: "M19.2 3H5.19995C4.09995 3 3.19995 3.9 3.19995 5V19C3.19995 20.1 4.09995 21 5.19995 21H19.2C20.3 21 21.2 20.1 21.2 19V5C21.2 3.9 20.3 3 19.2 3ZM19.2 19H5.19995V5H19.2V19Z", fill: "#00AA00" }),
        React.createElement("path", { d: "M11.45 7.72021H6.44995V9.22022H11.45V7.72021Z", fill: "#00AA00" }),
        React.createElement("path", { d: "M18.2 15.75H13.2V17.25H18.2V15.75Z", fill: "#00AA00" }),
        React.createElement("path", { d: "M18.2 13.25H13.2V14.75H18.2V13.25Z", fill: "#00AA00" }),
        React.createElement("path", { d: "M8.19995 18H9.69995V16H11.7V14.5H9.69995V12.5H8.19995V14.5H6.19995V16H8.19995V18Z", fill: "#00AA00" }),
        React.createElement("path", { d: "M14.29 10.95L15.7 9.54L17.11 10.95L18.17 9.89L16.76 8.47L18.17 7.06L17.11 6L15.7 7.41L14.29 6L13.23 7.06L14.64 8.47L13.23 9.89L14.29 10.95Z", fill: "#00AA00" })));
};
...
//   }
// `;
var zoomInOut = keyframes(templateObject_1$j || (templateObject_1$j = __makeTemplateObject(["{\n    0% {\n        transform: scale(1,1);\n    }\n    50% {\n        transform: scale(2,2);\n    }\n    100% {\n        transform: scale(1,1);\n    }\n}"], ["{\n    0% {\n        transform: scale(1,1);\n    }\n    50% {\n        transform: scale(2,2);\n    }\n    100% {\n        transform: scale(1,1);\n    }\n}"])));
var SpinnerIcon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React.createElement("image", { width: "96", height: "96", href: "images/cfn/9.png" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
        React.createElement("image", { width: "205", height: "26", href: isDark ? "images/cfn/LogoTextNewDark.png" : "images/cfn/LogoTextNewWhite.png" })));
};
...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "30px" }, isPushed ? (React.createElement(Icon$k, { width: "30px", color: "textSubtle" })) : (React.createElement(Icon$l, { width: "30px", color: "textSubtle" }))),
        ...
        if (entry.items) {
            return (React.createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: entry.initialOpenState, className: calloutClass }, isPushed &&
                entry.items.map(function (item) { return (React.createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
                    React.createElement(MenuLink, { href: item.href, target: item.blankTarget ? "_blank" : undefined }, item.label))); })));
        }
        return (React.createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
            React.createElement(MenuLink, { href: entry.href, onClick: handleClick, target: entry.blankTarget ? "_blank" : undefined },
                iconElement,
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container, null,
        React.createElement(SettingsEntry, { style: { justifyContent: "center" } },
            React.createElement(Flex, { style: { width: "100%", justifyContent: "center" } }, socials.map(function (social, index) {
        ...
        React.createElement(SocialEntry, null,
            React.createElement(Flex, { style: { width: '100%', justifyContent: 'space-between' } },
                CFNPriceUsd ? (React.createElement(PriceLink, { href: priceLink, target: "_blank", style: { margin: "auto" } },
...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        React.createElement(Text, { fontSize: "26px", bold: true, style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginBottom: "8px" } }, account),
        React.createElement(Flex, { mb: "32px" },
            React.createElement(LinkExternal, { small: true, href: "https://bscscan.com/address/" + account, mr: "22px" }, "View on BscScan"),
